...
public class LocationActivity extends FragmentActivity {
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return getString(R.string.title_location_section1).toUpperCase(l);
			case 1:
				return getString(R.string.title_location_section2).toUpperCase(l);
			}
			return null;
		}
	}
	 ...
	 * @param location - the location object
	 * @return zones - an array representing all of the zones the user has visited that day
	 */
	...
	/**
	 * Updates the table that displays all of the zones the user has been that day
	 */
